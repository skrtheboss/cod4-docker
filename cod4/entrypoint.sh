...
if [ $? != 0 ]; then
  ...
  echo "Compatibility: linking /cod4/main to /home/user/cod4/main\n"
  ln -s /cod4/main ./main
...
if [ $? != 0 ]; then
  ...
  echo "Compatibility: linking /cod4/mods to /home/user/cod4/mods\n"
  ln -s /cod4/mods ./mods
...
if [ $? != 0 ]; then
  ...
  echo "Compatibility: linking /cod4/usermaps to /home/user/cod4/usermaps\n"
...
if [ $? != 0 ]; then
  ...
  echo "Compatibility: linking /cod4/zone to /home/user/cod4/zone\n"
  ln -s /cod4/zone ./zone
